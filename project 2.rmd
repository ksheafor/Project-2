...
###GRAPH###
ggplot(books, aes_string(x= books$average_rating)) + geom_histogram(stat = "bin", binwidth = 0.05 , fill=graphcolor,color="black") + xlab("Average Rating (0-5)") + ylab("Number of Ratings (millions)")
```
